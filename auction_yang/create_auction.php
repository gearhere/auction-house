...
<?php
// TODO: include sellerID to insert auction data into database.
    ...
    <form method="post" action="create_auction_result.php">
      ...
      <div class="form-group row">
        ...
        <div class="col-sm-10">
          <select class="form-control" id="auctionCategory" name = 'auctionCategory'>
            ...
            <option value="Category2">Electrics</option>
            <option value="Category4">Sports, Hobbies & Leisure</option>
              <option value="Category5">Home Garden</option>
              <option value="Category6">Motors</option>
              <option value="Category7">Collectables & Art</option>
              <option value="Category8">Business, Office & Industrial Supplies</option>
              <option value="Category9">Health & Beauty</option>
              <option value="Category10">Media</option>
              <option value="Category11">Others</option>
          </select>
      ...
      <div class="form-group row">
        ...
        <div class="col-sm-10">
          ...
          <small id="endDateHelp" class="form-text text-muted"><span class="text-danger">* Required.</span> Day for the auction to end. It should be no earlier than current time.</small>
        </div>
      </div>
...
<!-- Might be useful for multiple selection.
...
function checkDate() {
  ...
  checkForm();
    ...
    // document.getElementById("demo1").innerHTML = c.getTime();
}
// https://developer.mozilla.org/en-US/docs/Web/Events

title.addEventListener("keyup", checkTitle);
category.addEventListener("change", checkCategory); //different trigger event.
