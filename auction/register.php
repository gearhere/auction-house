...
<form method="POST" action="process_registration.php">
  ...
  <div class="form-group row">
    <label for="postcode" class="col-sm-2 col-form-label text-right">Phone number</label>
	<div class="col-sm-10">
  ...
  <div class="form-group row">
    <label for="postcode" class="col-sm-2 col-form-label text-right">Secondary phone number</label>
	<div class="col-sm-10">
